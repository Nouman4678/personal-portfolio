          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1 style={{fontSize:"45px"}}>{`Hi! I'm`} <span style={{color:"green"}} className="txt-rotate" dataPeriod="1000" data-rotate='[ "Nouman Nadeem", " a Frontend Developer", "a Software Engineer" ]'><span className="wrap">{text}</span></span></h1>
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__zoomIn" : ""}>
                  <img src={headerImg} style={{marginTop:"25px",height:"275px"}} alt="Header Img"/>
                </div>}
            </TrackVisibility>
          </Col>
        </Row>
